  ...
  return (
    <>
      <Flex
        ...
        align="center"
      >
        <Box ml="1.5rem" display="flex" alignItems="center" cursor="pointer">
          <Image
            src={LogoImg}
        ...
        >
          ...
          >
            ...
            <Button w="100%" borderRadius="10px" onClick={closeLogath}>
              Sair
            </Button>
          </Box>
        </Box>
            ...
            return (
              <>
                ...
                >
                  ...
                  <Box>
                    <Text>Categoria do Automóvel :</Text>
                  </Box>
                  <Box>
                    <Text>{cars.categoryCar}</Text>
                  </Box>

                  <Box>
                    <Text>Marca do Automóvel :</Text>
                  </Box>
                  <Box>
                    <Text>{cars.barndCar}</Text>
                  </Box>

                  <Box>
                    <Text>Modelo do Automóvel :</Text>
                  </Box>
                  <Box>
                    <Text>{cars.modelCar}</Text>
                  </Box>

                  <Box>
                    <Text>Ano de Fabricação do Automóvel :</Text>
                  </Box>
                  <Box>
                    <Text>{cars.yearManufacturingCar}</Text>
                  </Box>

                  <Box>
                    <Text>Ano de Modelo do Automível :</Text>
                  </Box>
                  <Box>
                    <Text>{cars.yearModelCar}</Text>
                  </Box>

                  <Box>
                    <Text>Valor da Venda do Automível :</Text>
                  </Box>
                  <Box>
                    <Text>{cars.valueSaleCar}</Text>
                  </Box>

                  <Box>
                    <Text>Descrição do Automóvel :</Text>
                  </Box>
                  <Box>
                    <Text textAlign="justify">&nbsp;{cars.descriptionCar}</Text>
                  </Box>
                </Box>
                      ...
                      <Box mt="1rem">
                        ...
                        >
                          <Input
                            ...
                            onChange={(event) => {
                              setUpdateAnoFabricacaoAutomovel(
                                event.target.value
                              );
                            }}
                          />
                      ...
                      <Box my="1rem">
                        ...
                        >
                          <textarea
                            id="textarea__desc"
                            onChange={(event) => {
                              setUpdateDescricaoAutomovelAutomovel(
                                event.target.value
                              );
                            }}
                          ></textarea>
